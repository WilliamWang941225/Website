// Edit this file when you add, remove, or rename resources.
// The date will be detected from the local file in public/document/ when possible.

export const resourcesBase = [
  {
  ...
  {
    title: "Gravity",
    description: "A lecture held in the CCHS physics book club. Please be aware that there could be mistakes in the lecture notes as they were compiled earlier. If there are any differences between the two, please refer to the handouts as the primary source.",
